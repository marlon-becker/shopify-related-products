...
class SECP_Widget extends WP_Widget {
	 ...
	 * @since  0.0.9
	 */
	protected $widget_slug = 'shopify-related-products-widget';
	...
	public function __construct() {
		...
		$this->widget_name          = esc_html__( 'Shopify', 'shopify-related-products' );
		$this->default_widget_title = esc_html__( 'Shopify', 'shopify-related-products' );
		...
		parent::__construct(
			...
			array(
				...
				'description' => esc_html__( 'Embed a Shopify product and buy button.', 'shopify-related-products' ),
			)
		);
	...
	public function form( $instance ) {
		...
		// Do product preview.
		?>
		<p class="secp-widget-preview-wrap <?php if( empty( $instance['product_handle'] ) ) { echo 'no-product'; } ?>"><span class="secp-no-product"><?php esc_html_e( 'No Product Set', 'shopify-related-products' ); ?></span>
		...
		// Do button.
		$button_text = __( 'Add Product', 'shopify-related-products' );
		if ( $instance['product_handle'] ) {
			$button_text = __( 'Replace Product', 'shopify-related-products' );
		}
		?>
