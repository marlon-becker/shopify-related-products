<?php
/**
 * Plugin Name: Shopify Related Products
 * Description: Show products .
 * Version:     0.0.9
 * Author:      Marlon Becker
 * License:     GPLv2
 * Text Domain: shopify-related-products
 * Domain Path: /languages
 */

/**
 * Copyright (c) 2017 (email : marlon.mbs@gmail.com)
 *
...
function shopify_ecommerce_plugin_autoload_classes( $class_name ) {
	...
	Shopify_RelatedProducts_Plugin::include_file( $filename );
}
 ...
 */
class Shopify_RelatedProducts_Plugin {
	 ...
	 *
	 * @var Shopify_RelatedProducts_Plugin
	 * @since  1.0.0
	 */
	 ...
	 *
	 * @since  1.0.0
	 * @return Shopify_RelatedProducts_Plugin A single instance of this class.
	 */
	...
	public function plugin_classes() {
		...
		$this->shopify_service  = new SECP_Shopifyapi( $this );
	...
	public function init() {
		if ( $this->check_requirements() ) {
			load_plugin_textdomain( 'shopify-related-products', false, dirname( $this->basename ) . '/languages/' );
		}
	}
...
/**
 * Grab the Shopify_RelatedProducts_Plugin object and return it.
 * Wrapper for Shopify_RelatedProducts_Plugin::get_instance()
 *
 * @since  1.0.0
 * @return Shopify_RelatedProducts_Plugin  Singleton instance of plugin class.
 */
function shopify_ecommerce_plugin() {
	return Shopify_RelatedProducts_Plugin::get_instance();
}
